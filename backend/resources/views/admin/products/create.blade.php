...
@section('content')
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-rose-900 mt-2 dark:text-white" data-i18n="admin.products.create">Create Product</h2>
    </div>
    ...
    <div class="bg-white rounded-xl border border-rose-100 p-6 max-w-3xl dark:bg-gray-900 dark:border-rose-900/30">
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <input id="short_description" type="text" name="short_description" value="{{ old('short_description') }}" maxlength="500"
                       class="w-full px-4 py-2.5 border border-rose-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 dark:focus:ring-rose-400 dark:focus:border-rose-400">
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input id="compare_price" type="number" step="0.01" min="0" name="compare_price" value="{{ old('compare_price') }}"
                           class="w-full px-4 py-2.5 border border-rose-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 dark:focus:ring-rose-400 dark:focus:border-rose-400">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="quantity" type="number" min="0" name="quantity" value="{{ old('quantity', 0) }}" required
                           class="w-full px-4 py-2.5 border border-rose-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 dark:focus:ring-rose-400 dark:focus:border-rose-400">
                </div>
                <div>
            ...
            <div>
                <label for="images" class="block text-sm font-medium text-rose-700 mb-1 dark:text-rose-300" data-i18n="admin.products.images">Product Images</label>
                <input id="images" type="file" name="images[]" multiple accept="image/jpeg,image/png,image/webp"
                       class="w-full px-4 py-2.5 border border-rose-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 dark:focus:ring-rose-400 dark:focus:border-rose-400">
                <p class="text-xs text-rose-400 mt-1 dark:text-rose-500" data-i18n="admin.products.images_hint">JPEG, PNG, or WebP. Max 2MB each. First image becomes the thumbnail.</p>
            ...
            <div class="pt-2">
                <button type="submit" class="bg-rose-500 text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-rose-600 transition shadow-sm shadow-rose-200 dark:shadow-none dark:hover:bg-rose-700" data-i18n="admin.products.submit_create">
                    Create Product
                </button>
            </div>
        </form>
